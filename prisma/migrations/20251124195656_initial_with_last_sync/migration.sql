...
-- DropForeignKey
ALTER TABLE "MonitoredProject" DROP CONSTRAINT "MonitoredProject_userId_fkey";
...
-- CreateIndex
CREATE UNIQUE INDEX "LastSync_userId_key" ON "LastSync"("userId");

-- CreateIndex
CREATE INDEX "LastSync_userId_idx" ON "LastSync"("userId");
